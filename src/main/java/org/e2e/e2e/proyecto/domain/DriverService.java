...
public class DriverService {
    private final EmpleadoRepository driverRepository;
    ...
    @Autowired
    public DriverService(EmpleadoRepository driverRepository, VehicleService vehicleService) {
        this.driverRepository = driverRepository;
        this.vehicleService = vehicleService;
        this.modelMapper = new ModelMapper();
    }

    public EmpleadoResponseDto getDriverInfo(Long id) {
